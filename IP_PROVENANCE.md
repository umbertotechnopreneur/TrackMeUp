...
[MIT License](LICENSE) unless a file states otherwise. The WorkTrail name,
...
terms; inclusion in this repository does not relicense them as WorkTrail
material.
...
- Distinguish MIT-licensed project material, reserved WorkTrail Brand Assets, and third-party material in provenance records.
...
under the API key and plan selected by the person running WorkTrail. Those
...
The current first-party WorkTrail visual assets have a dated project-owner
...
- redistributed forks replace reserved WorkTrail Brand Assets unless separate permission has been granted;
