...
All generated files remain beside the script: `Meteo.csv` and `weather-report.json`.
...
`Meteo.csv` also acts as the cache, keyed by Code. A successful fetch stays reusable
