...
def main():
    ...
    existing = load_existing(args.data_folder / 'Calendari.csv')
    rows = []
    ...
    write_csv(stage / 'Calendari.csv', headers, rows)
    ...
    for row in load_existing(args.data_folder / 'Santi.csv'):
    ...
    write_csv(stage / 'Santi.csv', ['Month', 'Day', 'Name', 'Source'], saints)
