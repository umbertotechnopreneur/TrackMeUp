...
public sealed class TrayIconServiceTests
{
    ...
    public void TaskbarRecreation_RestoresLostIconAndPreservesWindowVisibility(bool visible)
    {
        ...
        Assert.Equal("TrackMeUp recovery test", fixture.Shell.ToolTip);
    ...
    {
        private readonly string _iconPath = Path.Combine(Path.GetTempPath(), $"TrackMeUp-tray-test-{Guid.NewGuid():N}.ico");
        ...
        public TrayFixture()
        {
            ...
            Window = CreateWindowEx(0x08000080, "STATIC", "TrackMeUp tray recovery test", 0x80000000,
        ...
        public void Hide() => Service.HideToNotificationArea(Window, _iconPath, "TrackMeUp recovery test",
