...
public sealed class CelestialRuntimeTests
{
    ...
    {
        var application = DispatchProxy.Create<ITrackMeUpApplication, CelestialRuntimeProxy>();
    ...
    public class CelestialRuntimeProxy : DispatchProxy
    {
        ...
        {
            if (targetMethod?.Name == nameof(ITrackMeUpApplication.GetCelestialMapAsync))
            {
            ...
            if (targetMethod?.Name == nameof(ITrackMeUpApplication.GetCelestialAsync))
            {
