...
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), "TrackMeUp-export-tests-" + Guid.NewGuid().ToString("N"));
    ...
    private static TrackMeUpApplication CreateApplication(LocalStore store, ProductTier tier) =>
