...
public sealed class LocalSearchService : ILocalSearchService
{
    ...
    private const string SchemaCommitKey = "worktrail.search.schema";
    private const string SourceRevisionCommitKey = "worktrail.search.source_revision";
