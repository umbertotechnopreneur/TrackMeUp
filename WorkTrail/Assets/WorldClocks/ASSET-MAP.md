...
- `Skylines/`: exactly 412 city/season RGBA PNG files at 1280×720.
...
- `design/world-clocks/watercolor/masters-v1/`: 412 original transparent PNG city masters.
- `design/world-clocks/watercolor/runtime-v4/`: 412 converted alpha WebP files plus the intermediate runtime manifest; these files are not loaded by WinUI.
- `design/world-clocks/watercolor/generation-manifest-v1.json`: the 206-city, two-season generation contract.
