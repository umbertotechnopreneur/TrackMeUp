...
- `Skylines/`: exactly 378 city/season RGBA PNG files at 1280×720.
...
- `design/world-clocks/watercolor/masters-v1/`: 378 original transparent PNG city masters.
- `design/world-clocks/watercolor/runtime-v4/`: 378 converted alpha WebP files plus the intermediate runtime manifest; these files are not loaded by WinUI.
- `design/world-clocks/watercolor/generation-manifest-v1.json`: the 189-city, two-season generation contract.
