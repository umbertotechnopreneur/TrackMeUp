...
{
    private readonly ComboBox _box = new() { MinWidth = 0, MaxWidth = 155, FontSize = 12, Padding = new Thickness(6, 2, 6, 2), Background = new SolidColorBrush(Microsoft.UI.Colors.Transparent) };
