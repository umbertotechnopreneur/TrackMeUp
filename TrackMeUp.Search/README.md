...
building a query. TrackMeUp supplies 300 curated concepts for each of its ten
...
TrackMeUp enables synonyms by default. For example, with Italian search selected,
...
[`search-synonyms.json`](../TrackMeUp.Core/search-synonyms.json) and a separate
[`search-synonyms/<locale>.json`](../TrackMeUp.Core/search-synonyms) file for each
...
See the [catalog editing guide](../TrackMeUp.Core/search-synonyms/README.md) for
