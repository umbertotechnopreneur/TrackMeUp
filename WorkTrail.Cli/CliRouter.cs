...
public sealed partial class CliRouter(IWorkTrailApplication application, CliOutput output, CliOptions options)
{
    private readonly IWorkTrailApplication _application = application;
