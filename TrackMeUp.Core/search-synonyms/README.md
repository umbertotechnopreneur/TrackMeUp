...
TrackMeUp ships 300 concepts in each of ten search locales: 3,000 localized
...
The prepared tests in `TrackMeUp.Core.Tests` validate deployed catalogs and
configuration failures. `TrackMeUp.Search.Tests` covers retrieval, phrases,
