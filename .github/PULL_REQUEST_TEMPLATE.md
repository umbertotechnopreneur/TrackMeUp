...
What does this change do for someone using or maintaining TrackMeUp? A few sentences are enough.
...
- [ ] New behavior goes through `ITrackMeUpApplication`; UI and CLI code only collect input and display results.
